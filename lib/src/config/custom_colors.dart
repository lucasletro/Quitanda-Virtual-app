...
abstract class CustomColors{
  ...
  static Color customContrastColor = Colors.red.shade700; //vermelho

  static MaterialColor customSwatchColor = MaterialColor(0xFF8BC34A, _swatchOpacity); //verde
